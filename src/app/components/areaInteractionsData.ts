...
export const AREA_INTERACTIONS: AreaInteractionItem[] = [
  {
    ...
    body: "A área traduz a estratégia do negócio, a necessidade do utilizador e a viabilidade do desenvolvimento numa linguagem única, mantendo o produto coerente entre essas três perspectivas durante todo o projecto.",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    body: "A área amplia a maturidade da empresa ao partilhar método, vocabulário e referências com as equipas com que opera, e o ganho de cada projecto espalha-se pela organização em vez de ficar restrito à entrega.",
  },
];
